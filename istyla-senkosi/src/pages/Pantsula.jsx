...
import entryAudio from "../assets/audio/Chapter Clips/pantsula-one.m4a";
import interviewAudio from "../assets/audio/Chapter Clips/pantsula-two.m4a";
...
function Pantsula() {
  ...
  return (
    ...
    <ChapterPlayer
      ...
      frames={[
        { label: "Memory collage / Jama’s view", collage: [editorial2, editorial1, editorial3], motion: "crossfade", galleryStyle: "crossfade", text: "Step. Step. Step. I try to follow the rhythm. For a moment, I imagine telling my cousin about it, then remember that I cannot." },
        { label: "Street energy / Fast cuts", video: entryVideo, audio: entryAudio, laceGate: true, playSeconds: 20, skipAfter: 10, caption: "MOVEMENT BUILDS / 20 SECOND CLIP" },
        { label: "Interview / Let them speak", video: interviewVideo, audio: interviewAudio, playSeconds: 20, skipAfter: 10, caption: "20 SECOND CLIP" },
        { label: "Details + environment", collage: [marketImage, seatedPortrait], motion: "crossfade", galleryStyle: "crossfade", text: "I can’t just look anymore. Trying the steps reminds me how much I took for granted when my cousin was here." },
