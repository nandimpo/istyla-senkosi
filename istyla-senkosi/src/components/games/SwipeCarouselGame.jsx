...
function SwipeCarouselGame({ images, onComplete }) {
  ...
  return <section className="game-stage game-stage--skhothane curved-gallery" onWheel={turnWithWheel}>
    <header className="game-copy curved-gallery__copy">
      ...
      <StitchedNarrative className="game-copy__narrative" text="I went back through everything I shot, one image after another, trying to see what I'd missed the first time." placement="inline" />
    </header>
    ...
    <p className="curved-gallery__hint">DRAG, SCROLL OR USE THE ARROWS TO LOOK BACK</p>
  </section>;
}
